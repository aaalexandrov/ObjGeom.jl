...
function prism(sides::Int, zMin::Float32 = -0.5f0, zMax::Float32 = 0.5f0; smooth::SMOOTHING = SmoothNone)
...
function pyramid(sides::Int, zMin::Float32 = 0f0, zMax::Float32 = 1f0; smooth::SMOOTHING = SmoothNone)
  model = regularpoly(sides, zMin, normals = false)
